...
<title>회원가입</title>
<link rel="stylesheet" href="css/signup_.css">
...
<body>
	...
	<!-- 회원가입 -->
	<form action="login.html" method="post" name="signupform"
		onsubmit="return chkSubmit()" action="signupOk.mc">
		<div id="body">
			<div id="info">
				<h5>회원정보 입력</h5>
				<input id="nickname" type="text" placeholder="(필수) 이메일 주소 or 아이디 입력" name="id" required> 
				<input type="password" placeholder="(필수) 비밀번호 입력" name="pw" required> 
				<input type="password" placeholder="(필수) 비밀번호 재확인" name="pw" required>
			...
			<div id="phone">
				...
				<div id="pNum">
					<input type="text" name="phoneNum"
						placeholder="(필수) 휴대폰 전화번호 입력(-제외)" required>
					<button type="button">인증</button>
				</div>
				<div id="check">
					<input type="text" name="certificationNum" placeholder="인증번호 입력"
						required>
